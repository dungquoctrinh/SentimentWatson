package com.tinkersstudio.sentimentwatson;
...
import com.tinkersstudio.sentimentwatson.R;
...
public class MainActivity extends AppCompatActivity {
    ...
    Button button;
    String sentiment;
    protected String KEY_API = "d4a97f67bd08aa3720bd3be9dc5c92ad720f16fa";

    private class AskWatsonTask extends AsyncTask<String, Void, String> {
        @Override
        protected String doInBackground(String... textsToAnalyse) {

            //System.out.println(MainActivity.this.editText.getText());
            ...
            //TODO: API key in here
            service.setApiKey(KEY_API);
